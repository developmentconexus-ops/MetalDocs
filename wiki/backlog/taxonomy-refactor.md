...
| R-006 | Add tier-2 authz.Require + DB tripwire (assert_caps) on document_profiles, document_process_areas, document_families | T-006 | L | Major | R-001, R-002 | — | open | — |
...
| R-013 | Add DB BEFORE-UPDATE trigger rejecting `NEW.code <> OLD.code` on document_families | T-013 | XS | Minor | — | — | open | — |
