...
| R-005 | Emit `auditdomain.Writer.Record` from `handleUserRoleUpsert` (and any other admin op missing audit) — match the call pattern in handlers that already do | T-005 | S | Major | — | — | open | — |
