...
- [backlog/iam-refactor.md](backlog/iam-refactor.md) — IAM refactor backlog (14 rows, R-001 through R-014); R-014 is the doc-only retire of iam-rbac.md (Last verified: 2026-05-10)
...
- **[modules/iam.md](modules/iam.md)** - IAM module — capabilities, roles, area memberships (Arc42 + C4); successor to iam-rbac.md (Last verified: 2026-05-10)
