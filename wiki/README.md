...
- [modules/templates_v2-tech-debt.md](modules/templates_v2-tech-debt.md) - templates_v2 tech-debt register (14 items: 3 Critical / 6 Major / 4 Minor — T-001 authz not applied, T-002 tenant guard gap, T-003 X-Tenant-ID header trust **RESOLVED Plan 3**, T-004 SoD gap on Publish, T-005 legacy error envelope, T-006 partial codegen, T-007 parallel audit sink, T-008 resolver registry unwired, plus 6 additional items) (Last verified: 2026-05-11)
...
- **[modules/iam.md](modules/iam.md)** - IAM module — capabilities, roles, area memberships (Arc42 + C4); covers tier-1 `CapabilityService.CanDo`, tier-2 `authz.Require`, Postgres tripwire, area-scoped authz, group grants, tenant-scoped repositories (Group B), migrations 0002–0170; Plan 3: middleware uses `tenant.FromContext` as primary tenant source with legacy-header fallback (Last verified: 2026-05-11)
- [modules/iam-tech-debt.md](modules/iam-tech-debt.md) - IAM tech-debt register (12 items, T-001 through T-012) (Last verified: 2026-05-11)
...
- [concepts/authz-tiers.md](concepts/authz-tiers.md) - two-tier authz model: tier-1 CapabilityService (HTTP middleware) vs tier-2 authz.Require (in-tx area check); GUC setup, pitfalls; AuthorizationService (third surface) deleted Plan 4 — T-003 closed (Last verified: 2026-05-11)
