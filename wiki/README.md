...
- [backlog/novo-template-wizard.md](backlog/novo-template-wizard.md) — **8 deferred items + 1 stub step** for Template Creation Wizard (`/templates-v2/new`): `template-counts` aggregate endpoint, `chk-disabled` hardcode, `next-code-preview` endpoint, `key-generation` UX decision, `font-size-hero` token gap, `step3-docx-upload` / `step3-placeholder-extract` / `step3-editor-handoff` (3 Step-3 deferred items), `permissions-roles-api` / `permissions-area-counts` / `permissions-user-count` (3 Step-4 deferred items); Steps 2–4 shipped 2026-05-09; Step 5 (Confirmação) not yet implemented. (Last verified: 2026-05-09)
