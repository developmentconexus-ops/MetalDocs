...
- API status snapshot (Plan 8 baseline): `documents Partial`, `approval Raw`, `templates Partial`, `registry Wrapper-only`, `taxonomy Raw`, `audit Partial`, `iam Partial`, `auth/platform Partial` -> see `architecture/api-contract.md`.
