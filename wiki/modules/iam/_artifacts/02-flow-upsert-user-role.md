...
|---|---|---|
| OpenAPI op | `upsertUserRole` | `api/openapi/v1/openapi.yaml:976` |
...
- `apps/api/cmd/metaldocs-api/permissions.go:112` maps `POST /api/v1/iam/users/*/roles` to `iamdomain.CapUserManage`.
...
- 2xx schema ref: `#/components/schemas/UpsertUserRoleResponse` (ref at `api/openapi/v1/openapi.yaml:999`; schema defined at `api/openapi/v1/openapi.yaml:3882`).
- Request schema ref: `#/components/schemas/UpsertUserRoleRequest` (ref at `api/openapi/v1/openapi.yaml:992`; schema defined at `api/openapi/v1/openapi.yaml:3871`).
- Error responses declared on this POST op: `400`, `401`, `403` (at `api/openapi/v1/openapi.yaml:1000,1007,1014`).
