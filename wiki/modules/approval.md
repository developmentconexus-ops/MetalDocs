...
**Last verified:** 2026-06-01 (signoff content-pin source aligned with active-document endpoint — fixes pre-existing 412 `precondition.content_hash_mismatch` on every approval; hardened to fail-closed on missing client pin or NULL server hash) | **Owner:** unassigned | **Status:** active | **Maturity:** L2
