...
- `wiki/modules/registry.md` exists as 128-line stub (Last verified 2026-05-07). Covers `controlled_documents` table, atomic create handler, `getActiveDocument` FULL OUTER JOIN, 8 HTTP routes, frontend RegistryDetailPage / PublishedDownloadCell, `DocumentInitializer` port. Refresh to Arc42 + C4 living doc.
