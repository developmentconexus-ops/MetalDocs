...
| `internal/modules/documents/approval/infrastructure/postgres_approval_repository.go:41` | `InsertInstance` | func | Tripwire-gated INSERT into `approval_instances` |
