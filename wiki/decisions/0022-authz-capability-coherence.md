...
> **Status:** Accepted (in execution) — direction + governance model approved 2026-06-03; **Phase 1 complete 2026-06-03** (registry hygiene, behavior-neutral); **Phase 2 complete 2026-06-03** (typed scope classification + lifecycle grant seed; spec annotation scoped + lint-activation deferred — see Phase 2 close-out); Phases 3–6 pending. Supersedes nothing; **extends** ADR [`0007`](0007-two-tier-authz.md) (two-tier model + lint harness) and ADR [`0021`](0021-tenant-vs-platform-admin-separation.md) (capabilities, not role names, are the enforced boundary).
