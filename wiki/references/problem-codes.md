...
| `auth.signature_invalid` | 401 | approval | `internal/modules/approval/http/errors.go:91` |
...
| `conflict.approval_route_duplicate_profile` | 409 | approval | `internal/modules/approval/http/errors.go:72` |
...
| `conflict.mark_reviewed_stale_revision` | 409 | approval | `internal/modules/approval/http/errors.go:150` |
...
| `conflict.signoff_duplicate` | 409 | approval | `internal/modules/approval/http/errors.go:58` |
| `conflict.stale_base` | 409 | platform | `internal/platform/problem/codes.go:268` |
| `conflict.stale_revision` | 409 | approval | `internal/modules/approval/http/errors.go:47` |
...
| `internal.db_privilege_missing` | 500 | approval | `internal/modules/approval/http/errors.go:97` |
| `internal.db_unknown` | 500 | approval | `internal/modules/approval/http/errors.go:98` |
...
| `internal.signature_misconfigured` | 500 | approval | `internal/modules/approval/http/errors.go:99` |
...
| `internal.upstream_timeout` | **504** — 504 Gateway Timeout: the deadline was exceeded waiting on a dependency, which is a narrower server fault than the internal. family default of 500 | approval | `internal/modules/approval/http/errors.go:121` |
| `internal.verdict_wrong_stage_kind` | 500 | approval | `internal/modules/approval/http/errors.go:173` |
...
| `notfound.approval_instance` | 404 | approval | `internal/modules/approval/http/errors.go:48` |
| `notfound.approval_instance_not_visible` | 404 | approval | `internal/modules/approval/http/errors.go:56` |
| `notfound.approval_route` | 404 | approval | `internal/modules/approval/http/errors.go:118` |
| `notfound.controlled_document` | 404 | controlleddocuments | `internal/modules/controlleddocuments/delivery/http/routes.go:528` |
| `notfound.delegation` | 404 | approval | `internal/modules/approval/http/errors.go:167` |
| `notfound.document` | 404 | approval | `internal/modules/approval/http/errors.go:148` |
...
| `notfound.revision` | 404 | documents | `internal/modules/documents/delivery/http/fillin_handler.go:160` |
...
| `permission.sod_cross_stage_duplicate` | 403 | approval | `internal/modules/approval/http/errors.go:75` |
...
| `precondition.if_match_required` | **428** — 428 Precondition Required (RFC 6585 §3): no precondition FAILED — the server refuses to act without one, which is the opposite of the 412 the precondition. family defaults to | approval | `internal/modules/approval/http/errors.go:78` |
| `precondition.lock_version_stale` | 412 | templates | `internal/modules/templates/delivery/http/errors.go:32` |
...
| `request.header_required` | 400 | approval | `internal/modules/approval/http/errors.go:107` |
...
| `request.if_match_malformed` | 400 | approval | `internal/modules/approval/http/errors.go:82` |
...
| `request.json_type_error` | 400 | approval | `internal/modules/approval/http/errors.go:126` |
...
| `request.param_format` | 400 | approval | `internal/modules/approval/http/errors.go:104` |
| `request.param_required` | 400 | approval | `internal/modules/approval/http/errors.go:106` |
| `request.param_too_many_values` | 400 | approval | `internal/modules/approval/http/errors.go:108` |
| `request.param_unmarshal` | 400 | approval | `internal/modules/approval/http/errors.go:105` |
...
| `state.approval_blocked_unresolved_comments` | 409 | approval | `internal/modules/approval/http/errors.go:111` |
| `state.approval_instance_completed` | 409 | shared | `internal/platform/problem/codes.go:238` |
| `state.approval_route_in_use` | 409 | approval | `internal/modules/approval/http/errors.go:71` |
| `state.approval_route_inactive` | 409 | approval | `internal/modules/approval/http/errors.go:119` |
...
| `state.document_not_draft` | 409 | approval | `internal/modules/approval/http/errors.go:141` |
| `state.document_not_published` | 409 | approval | `internal/modules/approval/http/errors.go:149` |
| `state.document_profile_archived` | 409 | shared | `internal/platform/problem/codes.go:223` |
| `state.fast_forward_not_eligible` | 409 | approval | `internal/modules/approval/http/errors.go:177` |
| `state.fast_forward_stage_not_completed` | 409 | approval | `internal/modules/approval/http/errors.go:176` |
...
| `state.placeholder_not_author_editable` | 409 | documents | `internal/modules/documents/delivery/http/fillin_handler.go:161` |
...
| `state.revision_not_draft` | 409 | documents | `internal/modules/documents/delivery/http/fillin_handler.go:162` |
| `state.sla_extension_no_active_stage` | 409 | approval | `internal/modules/approval/http/errors.go:187` |
...
| Code | Status | Module | Declared at |
|---|---|---|---|
| `validation.approval_stage_required` | 422 | approval | `internal/modules/approval/http/errors.go:161` |
...
| `validation.delegation_window_invalid` | 422 | approval | `internal/modules/approval/http/errors.go:166` |
...
| `validation.doc_type_code_required` | 422 | templates | `internal/modules/templates/delivery/http/errors.go:64` |
| `validation.document_subject_key_mismatch` | 422 | approval | `internal/modules/approval/http/errors.go:139` |
| `validation.effective_date_required` | 422 | approval | `internal/modules/approval/http/errors.go:76` |
| `validation.effective_to_not_after_effective_from` | 422 | approval | `internal/modules/approval/http/errors.go:152` |
...
| `validation.placeholder_name_duplicate` | 422 | templates | `internal/modules/templates/delivery/http/errors.go:56` |
| `validation.placeholder_name_invalid` | 422 | templates | `internal/modules/templates/delivery/http/errors.go:51` |
| `validation.placeholder_not_choice` | 422 | documents | `internal/modules/documents/delivery/http/fillin_handler.go:159` |
| `validation.profile_code_immutable` | 422 | taxonomy | `internal/modules/taxonomy/delivery/http/routes_profiles.go:55` |
| `validation.profile_not_configured` | 422 | approval | `internal/modules/approval/http/errors.go:145` |
| `validation.profile_unknown` | 422 | approval | `internal/modules/approval/http/errors.go:135` |
| `validation.reason_category_invalid` | 422 | approval | `internal/modules/approval/http/errors.go:137` |
| `validation.reason_for_change_required` | 422 | approval | `internal/modules/approval/http/errors.go:136` |
| `validation.reason_required` | 422 | approval | `internal/modules/approval/http/errors.go:116` |
| `validation.review_due_before_effective` | 422 | approval | `internal/modules/approval/http/errors.go:151` |
| `validation.revision_title_required` | 422 | approval | `internal/modules/approval/http/errors.go:138` |
| `validation.role_unknown` | 422 | platform | `internal/platform/problem/codes.go:301` |
| `validation.route_stage_required` | 422 | approval | `internal/modules/approval/http/errors.go:162` |
| `validation.route_stages_not_permitted` | 422 | approval | `internal/modules/approval/http/errors.go:160` |
| `validation.self_delegation` | 422 | approval | `internal/modules/approval/http/errors.go:165` |
| `validation.sla_extension_not_forward` | 422 | approval | `internal/modules/approval/http/errors.go:186` |
| `validation.sla_extension_reason_required` | 422 | approval | `internal/modules/approval/http/errors.go:188` |
...
| `validation.supersede_target_invalid` | 422 | approval | `internal/modules/approval/http/errors.go:62` |
| `validation.template_profile_mismatch` | 422 | shared | `internal/platform/problem/codes.go:315` |
| `validation.template_subject_key_mismatch` | 422 | approval | `internal/modules/approval/http/errors.go:140` |
| `validation.verdict_ready_on_approval_stage` | 422 | approval | `internal/modules/approval/http/errors.go:172` |
