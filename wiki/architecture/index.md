...
- **[r10-technical-architecture.md](r10-technical-architecture.md)** — **ACTIVE REBASELINED T1→T7 TECHNICAL-STAGE AUTHORITY.** T1 and T2 are operator-ratified; T3 is active.
...
Every T-stage requires material-decision adjudication **and** operator approval of a platform-facing summary before the next T-stage may open.
...
These remain valid where they do not conflict with the accepted Product Contract, adjudicated GCR, approved Launch topology or ratified T-stage conclusions:
...
When pages disagree on Launch capability, semantic ownership or current routing, the Product Contract + adjudicated GCR + Launch ownership topology + ratified T-stage authorities + current handoff control the target.