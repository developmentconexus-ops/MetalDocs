...
- State wiring summary: Step 5 reads identity, scope/profile, starting point, docx name, permissions mode, selected ids, and selectedProfile from `TemplateWizardPage`; mocked submit navigates to `/templates`.
...
- Smoke trace:
  ...
  - Confirmed primary invokes mocked submit and navigates to `/templates`.
