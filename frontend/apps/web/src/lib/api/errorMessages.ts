...
export const errorMessages: Record<string, string> = {
  ...
  'validation.sla_extension_not_forward': 'A nova data limite deve ser posterior ao prazo atual.',
  'validation.sla_extension_reason_required': 'Informe o motivo da prorrogação do prazo.',
  ...
  'state.sla_extension_no_active_stage': 'Não há etapa ativa com prazo configurado para prorrogar.',
