...
func TestPermissionResolver(t *testing.T) {
	...
	testCases := []struct {
		...
		{name: "v2 controlled-documents preview-code", method: http.MethodGet, path: "/api/v2/controlled-documents/preview-code", wantCap: iamdomain.CapDocView, wantGuard: true},
	}
