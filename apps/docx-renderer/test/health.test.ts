...
beforeAll(async () => {
  process.env.DOCX_RENDERER_SERVICE_TOKEN = 'test-token-0123456789';
  process.env.DOCX_RENDERER_PORT = '0';
  process.env.DOCX_RENDERER_S3_ACCESS_KEY = 'minioadmin';
  process.env.DOCX_RENDERER_S3_SECRET_KEY = 'minioadmin';
  app = await buildApp();
});
