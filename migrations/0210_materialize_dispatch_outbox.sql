...
CREATE TABLE IF NOT EXISTS metaldocs.materialize_dispatch_outbox (
    ...
    CONSTRAINT ux_materialize_dispatch_outbox_revision UNIQUE (tenant_id, revision_id)
);

CREATE INDEX IF NOT EXISTS ix_materialize_dispatch_outbox_pending
    ON metaldocs.materialize_dispatch_outbox (next_retry_at)
