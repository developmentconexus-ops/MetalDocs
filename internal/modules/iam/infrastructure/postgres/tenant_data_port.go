...
// EraseTenantData deletes (or, for tenant_lifecycle_jobs, scrubs) every row
// scoped to tenantID within tx, in the child-before-parent order documented
// on the type, and returns the per-table row counts affected.
