...
func (h *Handler) RegisterRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /api/v1/taxonomy/profiles", generated.ListTaxonomyProfilesV2)
	mux.HandleFunc("POST /api/v1/taxonomy/profiles", generated.CreateTaxonomyProfileV2)
	mux.HandleFunc("GET /api/v1/taxonomy/profiles/{code}", generated.GetTaxonomyProfileV2)
	mux.HandleFunc("PATCH /api/v1/taxonomy/profiles/{code}", generated.UpdateTaxonomyProfileV2)
	mux.HandleFunc("DELETE /api/v1/taxonomy/profiles/{code}", generated.ArchiveTaxonomyProfileV2)
	mux.HandleFunc("PUT /api/v1/taxonomy/profiles/{code}/default-template", generated.SetTaxonomyProfileDefaultTemplateV2)
	mux.HandleFunc("GET /api/v1/taxonomy/areas", generated.ListTaxonomyAreasV2)
	mux.HandleFunc("POST /api/v1/taxonomy/areas", generated.CreateTaxonomyAreaV2)
	mux.HandleFunc("GET /api/v1/taxonomy/areas/{code}", generated.GetTaxonomyAreaV2)
	mux.HandleFunc("PUT /api/v1/taxonomy/areas/{code}", generated.UpdateTaxonomyAreaV2)
	mux.HandleFunc("DELETE /api/v1/taxonomy/areas/{code}", generated.ArchiveTaxonomyAreaV2)
	mux.HandleFunc("GET /api/v1/taxonomy/families", generated.ListTaxonomyFamiliesV2)
	mux.HandleFunc("POST /api/v1/taxonomy/families", generated.CreateTaxonomyFamilyV2)
	mux.HandleFunc("GET /api/v1/taxonomy/families/{code}", generated.GetTaxonomyFamilyV2)
	mux.HandleFunc("PATCH /api/v1/taxonomy/families/{code}", generated.UpdateTaxonomyFamilyV2)
	mux.HandleFunc("DELETE /api/v1/taxonomy/families/{code}", generated.DeactivateTaxonomyFamilyV2)
}
