...
var (
	...
	ErrTenantNotPermitted = errors.New("auth: user has no role in the requested tenant")
	...
	ErrTenantClaimRequired = errors.New("auth: tenant claim required — user belongs to multiple tenants")
)
