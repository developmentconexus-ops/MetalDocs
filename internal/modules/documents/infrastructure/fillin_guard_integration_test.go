...
func TestFillInRepository_UpsertAuthorValue_GovernedSourceBlocked(t *testing.T) {
	...
	governed := infrastructure.PlaceholderValue{
		TenantID:      tid,
		RevisionID:    revID,
	...
	affected, err := repo.UpsertAuthorValue(ctx, infrastructure.PlaceholderValue{
		TenantID:      tid,
		RevisionID:    revID,
		PlaceholderID: "ph-governed",
...
func TestFillInRepository_UpsertAuthorValue_DefaultSourceAllowed(t *testing.T) {
	...
	defaultRow := infrastructure.PlaceholderValue{
		TenantID:      tid,
		RevisionID:    revID,
