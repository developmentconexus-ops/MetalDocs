...
func newAreaScopedDocument(t *testing.T, db *sql.DB) (repo *infrastructure.Repository, tenantID, areaCode, docID, ownerID string) {
	t.Helper()
	...
	r := infrastructure.New(db, iamdomain.NoopUserDisplayNameReader{}, controlleddocumentsdomain.NoopCDFieldReader{}, taxonomydomain.NoopAreaCatalogReader{})
