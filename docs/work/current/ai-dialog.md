...
>
> Delete this file after convergence. Do not merge it into the MetalDocs candidate or `main`.
...
candidate PR      #148
T8-F/T8-G         OPERATOR-RATIFIED / INTEGRATED
T8-H              OPERATOR-RATIFIED / INTEGRATION PENDING
T9→T12             NOT OPEN
implementation    BLOCKED
candidate CI      #1117 SUCCESS
...
candidate CI      required PASS + pr-title PASS
```
