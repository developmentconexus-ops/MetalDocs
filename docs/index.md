...
| Frontend product experience planning / wireframing | [Method](development/functional-html-wireframe-method.md) | Product-specific artifacts unless the current stage requires them |
