...
| Document confidentiality / who may read a document / future clearance | [Document confidentiality seam](decisions/document-confidentiality-seam.md) + [Authorization and audit](architecture/authorization-and-audit.md) | [Access Assignment read](decisions/access-assignment-read.md) when the current grant surface is implicated | Whole Wire/Persistence files, legacy ACL machinery, per-document sharing designs |
