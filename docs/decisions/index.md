...
| T8-G | Runtime / Process / Deployment | CURRENT / OPERATOR-RATIFIED / INTEGRATION PENDING | One modular-monolith runtime with PostgreSQL/River, private scanner/renderer, verified spool, fail-closed recovery, OTel/OTLP observability and reuse-first technical mechanisms | `../architecture/runtime.md` + `t8g-ratification.md` |
