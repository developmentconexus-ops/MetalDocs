...
| T8-E-FR | Document Official frontend read symmetry | REFINED / OPERATOR-RATIFIED PRECISION | Operation 47 additionally exposes disclosure-safe current open-Revision and active-obsolescence routing references; precision is folded into the wire SSOT and `frontend-read-symmetry.md` preserves the decision provenance | `../architecture/wire-contract.md` |
