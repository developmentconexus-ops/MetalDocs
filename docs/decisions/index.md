...
| T6 | Canonical journeys | CURRENT / RATIFIED + BOUNDED T11 REOPEN | Product/API/frontend journey semantics including `/notifications`, stable-Document Discussion and human-recognizable governance work in a fixed human-stable queue order | `../product/journeys.md` + [Discussion/Notifications authority](discussion-notifications-launch.md) + [My Work governance read precision](my-work-governance-identification-read.md) |
...
| T8-E | Executable wire contract | CURRENT / RATIFIED + BOUNDED T11 REOPEN | Base OAS 3.0.3 wire + exact eight-operation Discussion/Notifications extension = **86** application operations; governance-work row shape/order additionally consumes the bounded T11 read precision | `../architecture/wire-contract.md` + [Discussion/Notifications authority](discussion-notifications-launch.md) + [API census](api-operation-census.md) + [My Work governance read precision](my-work-governance-identification-read.md) |
...
| T8-E-DOA | Document Official action hints | REFINED / OPERATOR-RATIFIED PRECISION | Operation 47 returns required `allowed_actions` UX guidance derived from the same current canonical predicates as Document management commands; commands always recheck truth | [precision record](document-official-actions-read.md) + `../architecture/wire-contract.md` |
| T8-E-WG | My Work governance read projection | REFINED / OPERATOR-RATIFIED PRECISION | `WorkGovernanceItem` exposes exact governed `RevisionReference`; `listGovernanceWork` uses `document.code ASC, governance_attempt_id ASC`; row admission, case authority and operation census remain unchanged | [precision record](my-work-governance-identification-read.md) + `../architecture/wire-contract.md` |
| T8-F | Frontend Realization | CURRENT / OPERATOR-RATIFIED + BOUNDED T11 REOPEN | Semantic/lens frontend realization covers 86 operations; Notifications utility stays separate; Document Official consumes server-derived action hints; My Work governance rows consume subject-aligned `RevisionReference` and server-owned queue order without per-row case fan-out or client re-sort | `../architecture/frontend.md` + [Discussion/Notifications authority](discussion-notifications-launch.md) + [Document Official action precision](document-official-actions-read.md) + [My Work governance read precision](my-work-governance-identification-read.md) + `t8f-ratification.md` |
