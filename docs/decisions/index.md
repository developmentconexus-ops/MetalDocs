...
| T6 | Canonical journeys | CURRENT / RATIFIED + BOUNDED T11 REOPEN | `/notifications`, stable-Document Discussion, human-recognizable governance work, optional active-Step deadline and deadline-first My Work triage with four bounded deadline presets | `../product/journeys.md` + [Discussion/Notifications](discussion-notifications-launch.md) + [My Work read precision](my-work-governance-identification-read.md) + [Governance Step deadline](governance-step-deadline.md) |
...
| T8-E | Executable wire contract | CURRENT / RATIFIED + BOUNDED T11 REOPEN | Current 86-operation wire; `GovernanceRouteStep.due_in_days?`; `WorkGovernanceItem.due_at?`; `listGovernanceWork` deadline-first order + bounded `deadline_filter` + cursor-stable temporal anchor | `../architecture/wire-contract.md` + [API census](api-operation-census.md) + [My Work read precision](my-work-governance-identification-read.md) + [Governance Step deadline](governance-step-deadline.md) |
