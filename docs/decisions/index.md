...
| T6 | Canonical journeys | CURRENT / RATIFIED + BOUNDED T11 REOPEN | `/notifications`, stable-Document Discussion, human-recognizable governance work and real optional active-Step deadline; final due-aware My Work ordering/filter behavior is B05-F4 | `../product/journeys.md` + [Discussion/Notifications](discussion-notifications-launch.md) + [My Work read precision](my-work-governance-identification-read.md) + [Governance Step deadline](governance-step-deadline.md) |
...
| T8-E | Executable wire contract | CURRENT / RATIFIED + BOUNDED T11 REOPEN | Current 86-operation wire; GovernanceRouteStep gains optional due_in_days and WorkGovernanceItem gains optional due_at; final listGovernanceWork due-aware filters/order pending B05-F4 | `../architecture/wire-contract.md` + [Discussion/Notifications](discussion-notifications-launch.md) + [API census](api-operation-census.md) + [My Work read precision](my-work-governance-identification-read.md) + [Governance Step deadline](governance-step-deadline.md) |
...
| T8-E-WG | My Work governance read projection | REFINED / OPERATOR-RATIFIED + BOUNDED REOPEN | Exact governed RevisionReference remains current; former neutral code order is reopened because active-Step due_at is now Product truth; B05-F4 owns final queue order/filter | [My Work read precision](my-work-governance-identification-read.md) + [Governance Step deadline](governance-step-deadline.md) + `../architecture/wire-contract.md` |
...
| T8-F | Frontend Realization | CURRENT / OPERATOR-RATIFIED + BOUNDED T11 REOPEN | Semantic/lens realization covers 86 operations; My Work may present exact active-Step due_at; no manual priority and no client global re-sort; F4 pending | `../architecture/frontend.md` + [Discussion/Notifications](discussion-notifications-launch.md) + [Document Official action precision](document-official-actions-read.md) + [My Work read precision](my-work-governance-identification-read.md) + [Governance Step deadline](governance-step-deadline.md) + `t8f-ratification.md` |
