...
| T8-E-FR | Document Official frontend read symmetry | REFINED / OPERATOR-APPROVED PRECISION | Operation 47 additionally exposes disclosure-safe current open-Revision and active-obsolescence routing references; census remains 78 | `frontend-read-symmetry.md` + `../architecture/wire-contract.md` |
