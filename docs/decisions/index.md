...
| T11-CONF | Document confidentiality future seam | CURRENT / OPERATOR-RATIFIED | In-Area confidentiality is a decided FUTURE seam: governed ConfidentialityClass plus clearance grants as one conjunctive term on the T3 equation, class never entering identity/code; Launch capability delta ZERO, per-document ACL and Area-as-secrecy permanently excluded | `document-confidentiality-seam.md` |
