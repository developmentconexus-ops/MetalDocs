...
| T6 | Canonical journeys | CURRENT / RATIFIED + BOUNDED T11 REOPEN | `/notifications`, stable-Document Discussion, human-recognizable governance work, bounded deadline truth, and `/audit` as structured evidence investigation with purpose-built Query Assist; Audit remains evidence rather than current-state authority | `../product/journeys.md` + [Discussion/Notifications](discussion-notifications-launch.md) + [My Work read precision](my-work-governance-identification-read.md) + [Governance Step deadline](governance-step-deadline.md) + [Governance Case deadline read](governance-case-step-deadline-read.md) + [Audit investigation](audit-investigation-read.md) |
| T6-API | `/api/v1` application census | REFINED / RATIFIED T11 BOUNDED REOPEN | Current census = **89** operations; 11 Idempotency-Key creations; operation 90+ needs a new lawful basis | [API census](api-operation-census.md) + [Discussion/Notifications](discussion-notifications-launch.md) + [Audit investigation](audit-investigation-read.md) |
...
| T8-E | Executable wire contract | CURRENT / RATIFIED + BOUNDED T11 REOPEN | Current 89-operation wire; prior T11 deadline/read precisions remain; op78 is refined for structured Audit query/inspection and op87-op89 provide bounded Audit Query Assist reads | `../architecture/wire-contract.md` + [API census](api-operation-census.md) + [My Work read precision](my-work-governance-identification-read.md) + [Governance Step deadline](governance-step-deadline.md) + [Governance Case deadline read](governance-case-step-deadline-read.md) + [Audit investigation](audit-investigation-read.md) |
...
| T8-F | Frontend Realization | CURRENT / OPERATOR-RATIFIED + BOUNDED T11 REOPEN | Semantic/lens realization covers 89 operations; prior deadline/Notifications precisions remain; `/audit` uses op78 + op87-op89 for structured evidence investigation, recognition and Query Assist with no frontend Authorization matrix or client post-filter over incomplete pages | `../architecture/frontend.md` + [Discussion/Notifications](discussion-notifications-launch.md) + [Document Official action precision](document-official-actions-read.md) + [My Work read precision](my-work-governance-identification-read.md) + [Governance Step deadline](governance-step-deadline.md) + [Governance Case deadline read](governance-case-step-deadline-read.md) + [Audit investigation](audit-investigation-read.md) + `t8f-ratification.md` |
...
| T8-H | Whole-T8 Global Coherence | REFINED BY T11 BOUNDED REOPEN | Prior T8 closure remains current for unchanged architecture; bounded T11 deltas including Audit investigation require/receive bounded proof before implementation authorization | current bounded decisions + [Audit investigation](audit-investigation-read.md) + [T8-H ratification](t8h-ratification.md) |
| T9 | Golden Flows & Validation Baseline | CURRENT / OPERATOR-RATIFIED + BOUNDED T11 REOPEN | Existing validation baseline plus current bounded T11 proof obligations; current application census is 89 and Audit investigation adds bounded query/recognition/Query-Assist proof obligations | `../architecture/validation-baseline.md` + current bounded decisions + [Audit investigation](audit-investigation-read.md) + [T9 ratification](t9-ratification.md) |
