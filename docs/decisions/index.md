...
| T8-F | Frontend Realization | CURRENT / OPERATOR-RATIFIED + BOUNDED T11 REOPEN | Semantic/lens frontend realization now covers 86 operations and adds global Notifications utility route/feature without client authority duplication; Document Official consumes server-derived action hints | `../architecture/frontend.md` + [Discussion/Notifications authority](discussion-notifications-launch.md) + [Document Official action precision](document-official-actions-read.md) + `t8f-ratification.md` |
