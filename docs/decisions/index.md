...
| T11-CONF-L | Document confidentiality Launch promotion | OPEN / OPERATOR-AUTHORIZED / NOT RATIFIED | Bounded Product/T6 reopen bringing in-Area confidentiality into Launch V1: proposed census 89 → 97, no new permission family, B02/B03/B10/B11/B12/B13 bounded rebaseline; five open questions await operator adjudication | `document-confidentiality-launch.md` |
