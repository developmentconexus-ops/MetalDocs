...
| 3 | `milestone-3-notifications` | Notifications center real end-to-end (new backend + lifecycle emitters + wired screen) | in-progress — F3.1 + F3.2 closed; **F3.3 re-scoped to ADR-0044 domain-event pattern + spec Approved 2026-06-22** (HS-2 partially lifted); plan.md + TDD pending in a fresh session; then F3.4 (wire) | [milestone.md](milestone-3-notifications/milestone.md) |
