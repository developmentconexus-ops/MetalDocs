...
> **Status:** In progress — M0 + M1 + M2 passed (validator PASS + operator HS-1); M3 next
...
| 3 | `milestone-3-notifications` | Notifications center real end-to-end (new backend + lifecycle emitters + wired screen) | in-progress — F3.1 + F3.2 closed (read surface done); **F3.3 paused** pending event-architecture redesign (HS-2/HS-6, 2026-06-22 — see hard-stops); deep-research in flight | [milestone.md](milestone-3-notifications/milestone.md) |
