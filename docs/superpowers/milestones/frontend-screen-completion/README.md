...
> **Status:** In progress — M0 + M1 + M2 + M3 passed (validator PASS + operator HS-1); **M4 in-progress (started 2026-06-23)**
...
| 4 | `milestone-4-publicado-obsoleto` | Publicado "em breve" gaps closed + Documento Obsoleto variant built | in-progress | — |
