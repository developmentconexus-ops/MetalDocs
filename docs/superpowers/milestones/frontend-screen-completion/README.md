...
| 3 | `milestone-3-notifications` | Notifications center real end-to-end (new backend + 5 document-lifecycle emitters + wired screen) | in-progress — HS-1 start gate cleared (2026-06-22, emitter scope widened to lifecycle bundle); executing F3.1 | [milestone.md](milestone-3-notifications/milestone.md) |
