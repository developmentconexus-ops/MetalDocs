...
> **Status:** M0 + M1 + M2 passed (operator-approved HS-1, 2026-07-03). M3 in-progress (2026-07-03). Commits local, not pushed.
...
| 3 | `milestone-3-tenancy-chokepoint` | TxRunner auto-seed GUCs; RLS backstop covers worker/jobs; ADR 0027 amended | in-progress | — |
