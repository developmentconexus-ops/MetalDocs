...
> **Status:** In progress (Milestone 2b)
...
|---|-----------|----------------------|--------|-------------|
| 2b | `milestone-2b-approval-kernel-backend` | Backend workflow/permission/contract remediation (W1-W13, P1-P8) inside `documents/approval` + `iam` | in-progress (spec approved, F1 starting) | — |
