...
|---|---|---|---|
| M1 | `milestone-1-canonical-submit-backend` | Author submit (REV0 + REV≥1) succeeds on canonical /submit with in-tx server resolution; finalize chain deleted; idempotency map complete (findings 1–5, 16–17) | executing |
