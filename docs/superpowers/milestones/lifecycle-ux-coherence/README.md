...
| M2 | `milestone-2-fe-surface-ownership` | One submit implementation per artifact kind, author surfaces only; cockpit approver-only (findings 6–8, 13–14) | **validated** (validator PASS 2026-07-07) — pending HS-1 operator gate |
