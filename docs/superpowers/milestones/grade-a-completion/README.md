...
| 2 | `milestone-2-observability` | Drive composition ≥ A− — slog, scrapeable job metrics, app-level OTel spans | passed (HS-1 pending 2026-06-16) | [PASS](milestone-2-observability/qa/milestone-qa.md) |
