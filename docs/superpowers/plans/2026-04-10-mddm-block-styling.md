...
```bash
PGPASSWORD='***REDACTED***' "C:/Program Files/PostgreSQL/16/bin/psql.exe" -h 127.0.0.1 -p 5433 -U metaldocs_app -d metaldocs -f migrations/0068_add_theme_to_po_mddm_template.sql
```
